        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_TreatmentPlan_Frequency", "\"FrequencyPerWeek\" IN  (2, 3, 4)");
                    table.CheckConstraint("CK_TreatmentPlan_TotalDays", "\"TotalDays\" IN (20, 30, 50)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "TreatmentPlanTherapies",
                columns: table => new
                {
                    TreatmentPlanId = table.Column<int>(type: "integer", nullable: false),
                    TherapyTypeId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TreatmentPlanTherapies", x => new { x.TreatmentPlanId, x.TherapyTypeId });
                    table.ForeignKey(
                        name: "FK_TreatmentPlanTherapies_TherapyTypes_TherapyTypeId",
                        column: x => x.TherapyTypeId,
                        principalTable: "TherapyTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TreatmentPlanTherapies_TreatmentPlans_TreatmentPlanId",
                        column: x => x.TreatmentPlanId,
                        principalTable: "TreatmentPlans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TreatmentPlanTherapies_TherapyTypeId",
